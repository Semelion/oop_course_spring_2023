...
generator::generator(const std::string &json_src_file = "src/config.json", const std::string &type_of_mk = "ESP32",
                     const std::string &out_code_file = "smart_house_mqtt.ino",
                     const std::string &start_of_code_src_file = "src/start_of_code.txt",
                     const std::string &functions_src_file = "src/function.txt") {
